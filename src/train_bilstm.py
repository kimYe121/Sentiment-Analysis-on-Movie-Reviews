...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="BiLSTM training skeleton.")
...
def main() -> None:
    ...
    print("BiLSTM training skeleton is ready.")
    ...
    print("This script is reserved for a bidirectional LSTM model trained with word embeddings or GloVe vectors.")
